...
public abstract class Jogo implements Runnable {
	...
	/**
	 * Define qual é o meu jogador para fazer as falas de acordo
	 */
	public int meuJogador;
	
	/**
	 * Defini o jogador que abriu a rodada para o baralho rodar junto
	 */
	public int jogadorAbriu;
	/**
	 * Definir quantos jogos cada equipe tem
	 */
	public int[] jogos = new int[2];
	/**
	 *  Definir quem acabou de fazer um jogo para colocar amarelo
	 */
	public boolean[] fezJogo = new boolean[2];
	/**
	...
	/**
	 *  Jogador que fez a ultima jogada
	 */
	 ...
	 * Mão de dez aberta
	 */
	public boolean maoDezAberta;
	/**
	 * Jogadores adicionados a este jogo
	 */
	public Jogador[] jogadores = new Jogador[4];
	 ...
	 *            decidir
	 */
	public abstract void decideMao10(Jogador j, boolean aceita);
	...
	public boolean isAlguemTem11Pontos() {
		return pontosEquipe[0] == 10 || pontosEquipe[1] == 10;
	}
